...
<template>
  <section class="fixed bottom-8 right-8 z-50 grid h-20 w-20 cursor-pointer place-items-center rounded-full bg-gray-50 transition-all duration-300 ease-in-out hover:bg-gray-200 lg:bottom-16 lg:right-16 lg:h-24 lg:w-24" :class="ShowScroll ? 'visible opacity-100' : 'invisible opacity-0'" @click="ScrollToTop">
