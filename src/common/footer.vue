<template>
  <footer class="mt-10 grid h-fit w-full place-items-center">
    <main class="flex h-full w-4/5 flex-col items-center text-gray-50">
      ...
      <h5 class="mb-8 mt-4 cursor-default text-gray-50">&copy; 2024</h5>
    </main>
  </footer>
</template>
