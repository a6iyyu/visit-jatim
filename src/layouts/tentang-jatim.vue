...
<template>
  ...
  <!-- Selamat Datang -->
  <section class="h-fit w-full px-28 md:px-36 lg:px-64 xl:px-96 flex flex-col mt-24 mx-auto" data-aos="fade-up">
    ...
    <div class="h-fit w-full grid place-items-center mt-6 mx-auto" data-aos="fade-up">
      <p class="text-1xl text-gray-950 cursor-default font-medium text-justify" :style="{ lineHeight: '1.5' }">
        ...
        jelajahi keindahannya bersama, memahami warisan budaya yang istimewa, dan
        menghidupkan keajaiban alam, tradisi, dan kehidupan masyarakatnya.
      </p>
    </div>
  </section>

  <!-- Kedatangan di Jawa Timur -->
  <section class="h-fit w-full px-28 md:px-36 lg:px-64 xl:px-96 flex flex-col mt-14 mx-auto" data-aos="fade-up">
    <h2 class="text-3xl text-gray-950 cursor-default font-semibold text-start">
      KEDATANGAN DI JAWA TIMUR
    </h2>
    <hr class="h-0.5 w-full bg-gray-950 rounded-md" />
    <section class="h-fit w-full grid place-items-center mt-6 mx-auto" data-aos="fade-up">
      <p class="text-1xl text-gray-950 cursor-default font-medium text-justify"
        ...
        Jawa Timur memberikan pengalaman yang menakjubkan dengan berbagai pilihan
        transportasi yang memudahkan perjalanan. Provinsi ini dapat diakses
        melalui udara, darat, maupun laut, dengan bandara utama seperti Bandara
        Internasional Juanda di Surabaya. Jadi, Anda tak perlu takut atau bingung
        bagaimana caranya untuk pergi ke Jawa Timur!
      </p>
    </section>
  </section>

  <!-- Ibukota -->
  <section class="h-fit w-full px-28 mt-14 grid place-items-center">
    <iframe class="max-h-[30rem] h-[30rem] max-w-[85%] w-[85%]"
  ...
  <section class="h-[25rem] w-full px-28 grid place-items-center mt-14" data-aos="fade-up">
  ...
  <!-- Puncak Tertinggi -->
  <img src="../../static/img/seruni-point.jpg" class="h-[30rem] w-full px-28 object-cover mt-14 mx-auto"
    data-aos="fade-up" />
  <section class="h-fit w-full px-28 md:px-36 lg:px-64 xl:px-96 flex flex-col mt-14 mx-auto" data-aos="fade-up">
    <h2 class="text-3xl text-gray-950 cursor-default font-semibold text-start">
      PUNCAK TERTINGGI
  ...
  <!-- SDA -->
  <section class="h-fit w-w-full px-28 md:px-36 lg:px-64 xl:px-96 flex flex-col mt-14 mx-auto" data-aos="fade-up">
  ...
  <section class="h-fit w-full px-28 md:px-36 lg:px-64 xl:px-96 flex flex-col mt-24 mx-auto" data-aos="fade-up">
    ...
    <div class="h-fit w-full pl-16 mt-6" data-aos="fade-up">
      <ul class="text-1xl text-gray-950 cursor-default font-medium text-justify list-disc space-y-3" :style="{ lineHeight: '1.5' }">
        <li><a class="font-bold hover:underline" href="https://www.bmkg.go.id/cuaca/prakiraan-cuaca-indonesia.bmkg?Prov=12&NamaProv=Jawa%20Timur">Kondisi Cuaca</a></li>
        <li><a class="font-bold hover:underline" href="https://www.posindonesia.co.id/en">Kantor Pos</a></li>
      </ul>
    </div>
  </section>
  ...
  <!-- Blog -->
  <section class="h-fit w-full grid place-items-center my-24" id="terbaru-di-jatim" data-aos="fade-up">
    <Latest :data="blogs" />
  </section>
</template>