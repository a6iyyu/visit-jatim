<template>
  ...
  <section class="hero h-[40rem] w-full grid place-items-center bg-center bg-cover bg-no-repeat"
    :style="{ backgroundImage: 'url(../../static/img/surabaya.jpg)' }">
  ...
  <section class="h-fit w-full px-16 md:px-12 lg:px-28 mt-14" data-aos="fade-up">
    <div class="my-10 w-full md:w-3/4 lg:w-1/2 grid grid-cols-3 gap-4 ">
      <button @click="toggleAllBtn()"
        class="border border-slate-900 px-4 py-2 hover:bg-slate-900 hover:text-slate-50 transition-colors text-lg focus:text-slate-50 focus:bg-slate-900">Semua
      </button>
      <button @click="toggleKotaBtn()"
        class="border border-slate-900 px-4 py-2 hover:bg-slate-900 hover:text-slate-50 transition-colors text-lg focus:text-slate-50 focus:bg-slate-900">Kota
      </button>
      <button @click="toggleDesaBtn()"
        class="border border-slate-900 px-4 py-2 hover:bg-slate-900 hover:text-slate-50 transition-colors text-lg focus:text-slate-50 focus:bg-slate-900">Desa
      </button>
    </div>
  </section>
